...
PICS = (environ.get('PICS', 'https://graph.org/file/e5b993b3df030e6c04f56.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '875770605').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "Downloader_TGBot") # without @
...
DB_URI = environ.get("DB_URI", "mongodb+srv://aman:aman@cluster0.chnpche.mongodb.net/?retryWrites=true&w=majority")
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://web-production-0daec.up.railway.app/")
